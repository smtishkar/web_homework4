...
$experience = [
    ...
    'end_date' => 'Current',
    'Description' => 'Какой-то текст который описывает основные обязанности',
    ],
    [
    'job title' => 'Salesman',   
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        ...
        <?php foreach ($experience as $key => $value): ?> 
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $value ['job title']?>  </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $value ['start_date']?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $value ['end_date']?></span></h6>
